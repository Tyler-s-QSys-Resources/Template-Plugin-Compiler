...
IF exist "%userprofile%\Documents\QSC\Q-Sys Designer\Plugins" (
  set localPluginFolder=%userprofile%\Documents\QSC\Q-Sys Designer\Plugins
    ...
    IF exist "%userprofile%\OneDrive\Documents\QSC\Q-Sys Designer\Plugins" (
      set localPluginFolder=%userprofile%\OneDrive\Documents\QSC\Q-Sys Designer\Plugins
    )
  )
  
if not exist "%localPluginFolder%\%2" mkdir "%localPluginFolder%\%2"
